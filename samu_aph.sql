...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Nov-2017 às 02:11
...
--
-- Extraindo dados da tabela `achado`
--

INSERT INTO `achado` (`id`, `descricao`, `status`) VALUES
(1, 'FRATURA EXPOSTA PERNA', 0),
(2, 'VOMITO', 1),
(3, 'NAUSEA', 1),
(4, 'LESÃO JOELHO', 1),
(5, 'FORMIGAÇÃO ', 1),
...
INSERT INTO `bairro` (`id`, `descricao`, `observacao`, `status`) VALUES
(5, 'VILA A', '', 1),
(4, 'MORUMBI', 'regiao morumbi i', 1),
(6, 'VILA C', '', 1);
...
CREATE TABLE `configuracoes` (
  `id` int(11) NOT NULL,
  `range01` date NOT NULL,
  `range02` date NOT NULL,
...
INSERT INTO `configuracoes` (`id`, `range01`, `range02`, `statuslist`) VALUES
(1, '2017-06-06', '2017-12-12', 1);
...
--
-- Estrutura da tabela `fichaaph`
--

CREATE TABLE `fichaaph` (
  `id` int(11) NOT NULL,
  ...
  `hchegadalocal` datetime NOT NULL,
  `hsaidalocal` datetime NOT NULL,
  `hchegadafinal` datetime NOT NULL,
  ...
  `achado` varchar(200) NOT NULL,
  `colonizado` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `fichaaph`
--

INSERT INTO `fichaaph` (`id`, `codigo`, `data`, `sexo`, `idade`, `hsaida`, `hchegadalocal`, `hsaidalocal`, `hchegadafinal`, `datacadastro`, `idorigem`, `iddestino`, `idviatura`, `idnatureza`, `idbairro`, `achado`, `colonizado`, `obito`, `status`, `dataalteracao`, `user`) VALUES
(44, '2017008', '2017-09-27', 'MASCULINO', 3, '2017-10-27 23:55:23', '2017-10-28 00:00:23', '2017-10-27 00:15:23', '2017-10-28 00:45:23', '2017-10-27', 10, 11, 19, 7, 4, 'FRATURA EXPOSTA PERNA,\r\n', 0, 2, 0, '2017-10-30 16:09:00', ''),
(43, '321312', '2017-10-27', 'MASCULINO', 23, '2017-10-27 23:55:54', '2017-10-28 00:10:54', '2017-10-28 01:00:54', '2017-10-28 01:50:54', '2017-10-27', 10, 10, 18, 9, 5, 'VOMITO,\r\n', 0, 1, 1, NULL, ''),
(42, '201707', '2017-10-27', 'FEMININO', 18, '2017-10-27 16:35:19', '2017-10-27 16:55:19', '2017-10-27 17:00:19', '2017-10-27 17:05:58', '2017-10-27', 11, 11, 19, 9, 5, 'NAUSEA,\r\n', 0, 1, 1, NULL, ''),
(41, '201706', '2017-10-27', 'MASCULINO', 35, '2017-10-27 16:36:03', '2017-10-27 16:36:04', '2017-10-27 16:36:05', '2017-10-27 16:36:07', '2017-10-27', 10, 10, 19, 7, 4, 'FRATURA EXPOSTA PERNA,\r\n', 0, 1, 1, NULL, ''),
(40, '2017005', '2017-09-27', 'FEMININO', 87, '2017-10-27 23:45:48', '2017-10-27 23:55:48', '2017-10-28 00:05:48', '2017-10-28 00:15:42', '2017-10-27', 11, 11, 19, 9, 4, 'VOMITO,\r\nNAUSEA,\r\n', 0, 1, 1, NULL, ''),
(39, '201703', '2017-10-27', 'MASCULINO', 14, '2017-10-27 10:25:40', '2017-10-27 10:30:40', '2017-10-27 10:35:40', '2017-10-27 10:45:40', '2017-10-27', 10, 10, 18, 7, 4, 'NAUSEA,\r\n', 0, 1, 1, NULL, ''),
(14, '2017002', '2017-10-27', 'FEMININO', 9, '2017-10-26 23:40:29', '2017-10-26 23:45:29', '2017-10-27 23:50:29', '2017-10-27 00:05:29', '2017-10-27', 11, 11, 19, 10, 4, 'LESãO JOELHO,\r\n', 0, 1, 1, NULL, ''),
(37, '2017001', '2017-11-27', 'FEMININO', 9, '2017-10-27 13:30:53', '2017-10-27 13:35:53', '2017-10-27 13:40:53', '2017-10-27 13:45:53', '2017-10-27', 11, 11, 17, 10, 4, 'LESãO JOELHO,\r\n', 0, 1, 1, NULL, ''),
(45, '4242', '2017-08-27', 'FEMININO', 2, '2017-10-27 19:32:00', '2017-10-27 19:32:01', '2017-10-27 19:32:04', '2017-10-27 19:32:05', '2017-10-27', 9, 9, 18, 8, 6, 'NAUSEA,\r\n', 0, 1, 1, NULL, ''),
(47, '2017009', '2017-10-30', 'FEMININO', 55, '2017-10-30 15:12:11', '2017-10-30 15:12:13', '2017-10-30 15:12:15', '2017-10-30 15:12:17', '2017-10-30', 9, 9, 19, 10, 4, 'LESÃO JOELHO,', 0, 2, 0, '2017-10-30 16:09:00', ''),
(48, '321', '2017-10-30', 'FEMININO', 1, '2017-10-30 16:26:51', '2017-10-30 16:26:53', '2017-10-30 16:26:58', '2017-10-30 16:27:01', '2017-10-30', 9, 9, 18, 7, 5, 'NAUSEA,', 0, 1, 1, NULL, 'administrador'),
(49, '312312', '2017-10-30', 'MASCULINO', 12, '2017-10-30 16:30:10', '2017-10-30 16:30:19', '2017-10-30 16:30:30', '2017-10-30 16:30:39', '2017-10-30', 9, 9, 19, 10, 4, 'FRATURA EXPOSTA PERNA,', 0, 1, 1, NULL, 'João : Administrador'),
(50, '312', '2017-10-30', 'FEMININO', 4, '2017-10-30 19:06:36', '2017-10-30 19:06:38', '2017-10-30 19:06:39', '2017-10-30 19:06:40', '2017-10-30', 10, 11, 18, 8, 5, 'VOMITO,', 1, 1, 1, NULL, 'João , Administrador'),
(51, '32132', '2017-10-30', 'FEMININO', 12, '2017-10-30 19:07:15', '2017-10-30 19:07:17', '2017-10-30 19:07:18', '2017-10-30 19:07:19', '2017-10-30', 9, 9, 17, 10, 5, 'NAUSEA,', 1, 3, 1, NULL, 'administrador , Administrador'),
(52, '123456', '2017-10-30', 'MASCULINO', 88, '2017-10-30 19:09:54', '2017-10-30 19:09:55', '2017-10-30 19:09:56', '2017-10-30 19:09:58', '2017-10-30', 11, 11, 17, 7, 6, 'NAUSEA,', 0, 1, 1, NULL, 'administrador , Administrador');
...
INSERT INTO `natureza` (`id`, `descricao`, `idtipoocorrencia`, `status`) VALUES
(10, 'TORÇÃO', 2, 1),
(9, 'DESMAIO', 1, 1),
(8, 'VERTIGEM', 1, 1),
(7, 'ACIDENTE TRABALHO', 2, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `origemdestino`
--
...
--
-- Extraindo dados da tabela `origemdestino`
--

INSERT INTO `origemdestino` (`id`, `descricao`, `status`) VALUES
(11, 'VILA B', 1),
(10, 'VILA A', 1),
(9, 'MORUMBI I', 1);
...
INSERT INTO `tipoocorrencia` (`id`, `descricao`, `status`) VALUES
(1, 'CLÍNICA', 1),
(2, 'TRAUMÁTICA', 1);
...
INSERT INTO `usuario` (`id`, `nome`, `user`, `password`, `tipo`, `status`) VALUES
(12, 'Comum', 'comum', 'e10adc3949ba59abbe56e057f20f883e', 2, 1),
(11, 'Administrador', 'administrador', 'e10adc3949ba59abbe56e057f20f883e', 1, 1);
...
CREATE TABLE `viatura` (
  ...
  `datacad` varchar(12) DEFAULT NULL,
  `status` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `viatura` (`id`, `descricao`, `tipo`, `datacad`, `status`) VALUES
(19, 'USB01', 'MOTO', '26-10-2017', 1),
(18, 'USA02', 'CARRO', '19-10-2017', 1),
(17, 'USA01', 'CARRO', '19-10-2017', 1);
...
--
-- Indexes for table `fichaaph`
--
ALTER TABLE `fichaaph`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `origemdestino`
--
ALTER TABLE `origemdestino`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `descricao` (`descricao`);
...
--
-- AUTO_INCREMENT for table `achado`
--
ALTER TABLE `achado`
...
--
-- AUTO_INCREMENT for table `fichaaph`
--
ALTER TABLE `fichaaph`
...
--
-- AUTO_INCREMENT for table `origemdestino`
--
ALTER TABLE `origemdestino`
